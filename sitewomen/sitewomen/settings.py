...
# при этом в url пропишется параметр next и при последующей авторизации, пользователя перенаправит на страницу, ранее с которой
# от был перенаправлен для авторизации
...
AUTHENTICATION_BACKENDS = [ # backend классы, ответственные за авторизацию пользователя на сайте
...
# задаем ссылку на класс пользователя
# нужно определять, если переопределяем класс User или расширяем его
AUTH_USER_MODEL = 'users.User'

DEFAULT_USER_IMAGE = MEDIA_URL + 'users/default.png' # путь к изображению профиля пользователя, пока не задано основное изображение
